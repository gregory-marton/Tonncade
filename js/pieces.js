...
const Pieces = {
    ...
    // place, so the pool a difficulty level draws from is exactly a cell-count band. 1-indexed to
    // match DifficultyBarbell's integer levels directly (level N -> DIFFICULTY_KEYS[N-1]):
